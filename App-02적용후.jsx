...
/*
    ...
    단 여러개의 하위값을 가진 스테이트를 관리 할 때 유용한다.
    또한 컴포넌트에서 상태를 업데이트하는 로직을 분리할 수 있다 
...
/*
    Reducer 함수
    스테이트를 업데이트 하는 역할의 함수로 
    Redux의 Store와 유사하다.
    매개변수의 첫번째는 현재상태, 두번째는 상태 변경을 위한 객체를 전달받는다.
*/
...
function App(){
    /*
        ...
        형식]
            ...
            변수 count의 초기값은 0으로 설정한다다
    */
    const [count, countDispatch] = useReducer(countReducer,0);
    //입력상자의 증가치 변경을 위한 스테이트와 함수 정의
    const [number, setNumber] = useState(1);
    //입력상자의 onChange 이벤트 리스너에서 호출출
